...
-- Players
CREATE POLICY IF NOT EXISTS "Anyone can read players"
ON public.players FOR SELECT
USING (true);

CREATE POLICY IF NOT EXISTS "Only admins can modify players"
...
CREATE POLICY IF NOT EXISTS "Scorers and admins can modify matches"
...
CREATE POLICY IF NOT EXISTS "Scorers and admins can modify attendance"
...
-- ELO history
CREATE POLICY IF NOT EXISTS "Anyone can read elo_history"
ON public.elo_history FOR SELECT
USING (true);

-- optional: restrict inserts to scorer/admin; no updates/deletes allowed by default
CREATE POLICY IF NOT EXISTS "Scorers and admins can insert elo_history"
